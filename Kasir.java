...
public class Kasir {
    ...
    for (int i = 0; i < daftarMeja.length; i++) {
        System.out.println((i + 1) + ". Meja " + daftarMeja[i].getNomorMeja() + " - " + (daftarMeja[i].isKosong()? "Tersedia" : "Ditempati"));
    }
    System.out.println();
    }
    ...
    public void tambahPelanggan(int nomorMeja, Pelanggan pelanggan) {
        ...
        if (daftarMeja[nomorMeja - 1].isKosong()) {
            ...
            System.out.println("Pelanggan " + pelanggan.getNama() + " ditambahkan ke Meja " + nomorMeja);
        } else {
    ...
    public void tambahPesanan(int nomorMeja, Menu menu) {
        ...
        if (menu!= null) {
            ...
            System.out.println("Menu " + menu.getNama() + " ditambahkan ke Meja " + nomorMeja);
        } else {
    ...
    public void hapusPelanggan(int nomorMeja) {
        ...
        if (!daftarMeja[nomorMeja - 1].isKosong()) {
            ...
            System.out.println("Pelanggan di Meja " + nomorMeja + " dihapus");
        } else {
            System.out.println("Meja " + nomorMeja + " tidak ada pelanggan");
        }
    }
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    int nomorMejaInput = scanner.nextInt();
                    scanner.nextLine();
                    System.out.print("Masukkan nama pelanggan: ");
                    String namaPelanggan = scanner.nextLine();
                    Pelanggan pelangganBaru = new Pelanggan(namaPelanggan);
                    tambahPelanggan(nomorMejaInput, pelangganBaru);
                    break;
                case 3:
                ...
                case 5:
                    ...
                    if (totalHarga > 0) {
                        System.out.println("Total harga pesanan di Meja " + nomorMejaHarga + " adalah Rp" + totalHarga);
                    } else {
                        System.out.println("Tidak ada pesanan di Meja " + nomorMejaHarga);
                    }
                    break;
                case 6:
